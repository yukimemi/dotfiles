...
linearf.utils.command(
    "nnoremap <silent><space>l/ :<c-u>lua linearf.run('line')<CR>")
linearf.utils.command(
    "nnoremap <silent><space>lf :<c-u>lua linearf.run('file')<CR>")
linearf.utils.command(
    "nnoremap <silent><space>lg :<c-u>lua linearf.run('grep')<CR>")
