...
// File        : cmp.ts
// Author      : yukimemi
// Last Change : 2025/08/03 14:49:29.
// =============================================================================
...
export const cmp: Plug[] = [
  ...
  { url: "https://github.com/dmitmel/cmp-cmdline-history", profiles: ["completion"] },
  ...
  { url: "https://github.com/chrisgrieser/cmp-nerdfont", profiles: ["completion"] },
  { url: "https://github.com/hrsh7th/cmp-nvim-lsp-signature-help", profiles: ["completion"] },
  { url: "https://github.com/hrsh7th/cmp-nvim-lsp-document-symbol", profiles: ["completion"] },
  { url: "https://github.com/uga-rosa/cmp-denippet", profiles: ["completion"] },
  { url: "https://github.com/uga-rosa/denippet.nvim", profiles: ["completion"] },
  { url: "https://github.com/teramako/cmp-cmdline-prompt.nvim", profiles: ["completion"] },
  {
