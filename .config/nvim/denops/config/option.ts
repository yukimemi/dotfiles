...
import * as nvimOption from "https://deno.land/x/denops_std@v6.4.3/option/nvim/mod.ts";
...
import { stdpath } from "https://deno.land/x/denops_std@v6.4.3/function/nvim/mod.ts";
