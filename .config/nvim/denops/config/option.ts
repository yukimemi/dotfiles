...
import * as nvimOption from "https://deno.land/x/denops_std@v6.2.0/option/nvim/mod.ts";
...
import { stdpath } from "https://deno.land/x/denops_std@v6.2.0/function/nvim/mod.ts";
