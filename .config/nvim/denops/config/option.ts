...
import * as nvimOption from "https://deno.land/x/denops_std@v6.0.1/option/nvim/mod.ts";
...
import { stdpath } from "https://deno.land/x/denops_std@v6.0.1/function/nvim/mod.ts";
