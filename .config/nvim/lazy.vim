...
" Pack 'kaneshin/ctrlp-filetype', {'type': 'lazy'}
" Pack 'kaneshin/ctrlp-memolist', {'type': 'lazy'}
" Pack 'kaneshin/ctrlp-sonictemplate', {'type': 'lazy'}
" Pack 'kassio/neoterm', {'type': 'lazy', 'if': has('nvim')}
" Pack 'mattn/ctrlp-launcher', {'type': 'lazy'}
" Pack 'mattn/ctrlp-mark', {'type': 'lazy'}
...
" Pack 'prabirshrestha/asyncomplete-emoji.vim', {'type': 'lazy'}
" Pack 'prabirshrestha/asyncomplete-file.vim', {'type': 'lazy'}
